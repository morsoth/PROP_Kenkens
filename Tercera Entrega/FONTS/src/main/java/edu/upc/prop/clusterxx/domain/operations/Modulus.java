...
/**
 * Clase que representa la operación aritmética Módulo.
 * 
...
public class Modulus extends Operation {
     ...
     * 
     * <p>Inicializa una nueva instancia de {@code Modulus} llamando al 
    ...
    /**
     * Calcula el módulo de los valores de las casillas.
     * 
     * <p>Este método toma un array de objetos {@code Box}, obtiene el valor 
     * de cada uno y retorna el módulo de los valores. Sólo se puede realizar
     * la operación sobre 2 casillas. Siempre se hace el número mas pequeño
     * módulo el mas grande.</p>
     * 
     * @param boxes Array de {@code Box} sobre los cuales se realizará la operación
     * @return Resultado del módulo si es posible, -1 si no es posible
     */
    @Override 
